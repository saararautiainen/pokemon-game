/* autogenerated by Processing revision 1281 on 2024-02-10 */
...
public class week_8 extends PApplet {
...
boolean showPokemonName = false;
 ...
 public void setup() {
  ...
  offset = PApplet.parseInt(random(0, 100));
 ...
 public void draw() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "week_8" };
    if (passedArgs != null) {
